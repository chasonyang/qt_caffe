...
class EltwiseAffineParameter : public ::google::protobuf::Message {
 public:
  ...
  inline EltwiseAffineParameter* New() const { return New(NULL); }

  EltwiseAffineParameter* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
class SubRegionParameter : public ::google::protobuf::Message {
 public:
  ...
  inline SubRegionParameter* New() const { return New(NULL); }

  SubRegionParameter* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
