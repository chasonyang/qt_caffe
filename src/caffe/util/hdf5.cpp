...
void hdf5_load_nd_dataset_helper(
  ...
  switch (class_) {
  case H5T_FLOAT:
  {LOG_INFO << "Datatype class: H5T_FLOAT"; }
    break;
  case H5T_INTEGER:
  {LOG_INFO << "Datatype class: H5T_INTEGER"; }
    break;
  case H5T_TIME:
  {LOG_FATAL << "Unsupported datatype class: H5T_TIME";  }
  case H5T_STRING:
  {LOG_FATAL << "Unsupported datatype class: H5T_STRING"; }
  case H5T_BITFIELD:
  {LOG_FATAL << "Unsupported datatype class: H5T_BITFIELD"; }
  case H5T_OPAQUE:
  {LOG_FATAL << "Unsupported datatype class: H5T_OPAQUE"; }
  case H5T_COMPOUND:
  {LOG_FATAL << "Unsupported datatype class: H5T_COMPOUND"; }
  case H5T_REFERENCE:
  {LOG_FATAL << "Unsupported datatype class: H5T_REFERENCE"; }
  case H5T_ENUM:
  {LOG_FATAL << "Unsupported datatype class: H5T_ENUM"; }
  case H5T_VLEN:
  {LOG_FATAL << "Unsupported datatype class: H5T_VLEN"; }
  case H5T_ARRAY:
  {LOG_FATAL << "Unsupported datatype class: H5T_ARRAY"; }
  default:
  {LOG_FATAL << "Datatype class unknown"; }
  }
